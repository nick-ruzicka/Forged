"""Continuous UI testing agent. Uses Playwright to exercise the Forge frontend."""
...
def main() -> None:
    ...
    print(f"[ui_tester] started. Base URL: {BASE_URL}. Report: {REPORT_FILE}")
