"""Continuous API testing agent. Hits every Forge endpoint in a loop."""
...
def main() -> None:
    ...
    print(f"[api_tester] started. Base URL: {BASE_URL}. Report: {REPORT_FILE}")
    while True:
        try:
            ...
            print(f"[api_tester] cycle error: {exc}")
